...
class RecordInfrastructureTests(unittest.TestCase):
    ...
    def test_repository_lists_records_only_for_folder_and_owner(self) -> None:
        ...
        foreign_record = self.record_repository.get_by_id_and_owner(999999, owner_user_id=1)
        self.assertIsNone(foreign_record)

    def test_registry_is_created_with_short_text_type(self) -> None:
        ...
        self.assertIsNotNone(registry.get("short_text"))
